...
const ContactUs = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Frontend - Form data as JSON:', JSON.stringify(formData, null, 2));
            ...
            <div className="max-w-3xl mx-auto mb-16">
              <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-8 border border-white/10 shadow-2xl">
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  Get in touch with our expert team to discuss how KNAV can help you leverage 
                  AI, machine learning, and advanced analytics to drive your success.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      />
                      {errors.emailAddress && (
                        <p className="mt-1 text-sm text-red-400">{errors.emailAddress}</p>
                      )}
                    </div>
                  </div>
